...
func (v MemFlags) String() string {
	switch v {
	case MEM_READ_WRITE: return "MEM_READ_WRITE"
	case MEM_WRITE_ONLY: return "MEM_WRITE_ONLY"
	case MEM_READ_ONLY: return "MEM_READ_ONLY"
	case MEM_USE_HOST_PTR: return "MEM_USE_HOST_PTR"
	case MEM_ALLOC_HOST_PTR: return "MEM_ALLOC_HOST_PTR"
	case MEM_COPY_HOST_PTR: return "MEM_COPY_HOST_PTR"
	case MEM_HOST_WRITE_ONLY: return "MEM_HOST_WRITE_ONLY"
	case MEM_HOST_READ_ONLY: return "MEM_HOST_READ_ONLY"
	case MEM_HOST_NO_ACCESS: return "MEM_HOST_NO_ACCESS"
	case MEM_SVM_FINE_GRAIN_BUFFER: return "MEM_SVM_FINE_GRAIN_BUFFER"
	case MEM_SVM_ATOMICS: return "MEM_SVM_ATOMICS"
	case MEM_KERNEL_READ_AND_WRITE: return "MEM_KERNEL_READ_AND_WRITE"
	default: return fmt.Sprintf("UNKNOWN (%d)", v)
	}
}
func (v MemMigrationFlags) String() string {
	switch v {
	case MIGRATE_MEM_OBJECT_HOST: return "MIGRATE_MEM_OBJECT_HOST"
	case MIGRATE_MEM_OBJECT_CONTENT_UNDEFINED: return "MIGRATE_MEM_OBJECT_CONTENT_UNDEFINED"
	default: return fmt.Sprintf("UNKNOWN (%d)", v)
	}
}
...
func (v MapFlags) String() string {
	...
	case MAP_WRITE_INVALIDATE_REGION: return "MAP_WRITE_INVALIDATE_REGION"
	default: return fmt.Sprintf("UNKNOWN (%d)", v)
	}
}
